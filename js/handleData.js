    ...
    success: function (data) {
      ...
      <div class="content_text" style="height: 2.29rem;overflow: hidden;">
        ...
        switch (data.page5.type) {
          ...
          <div class="second_title">专属报告</div>
          <div class="second_text">
            <p>2018年度最常飞行目的地${data.page5.extra.mostOftenLine[0]}-${data.page5.extra.mostOftenLine[1]}</p>
        ...
        <div class="second_title">专属报告</div>
        <div class="second_text">
          <p>2018年度，飞往海岛${data.page5.extra.times}次</p>
          <p>去过的海岛有</p>
          ${tempDom}
        </div>`;
        ...
        $("#ad").find("img").attr("src",window.nickArr[window.type - 1].ad);
    }
})
